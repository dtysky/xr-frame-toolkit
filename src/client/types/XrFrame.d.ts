...
declare module 'XrFrame/components' {
    ...
    export { default as ARTracker, IARTrackerData, ARTrackSchema, TTrackMode, EARTrackerState, IARTrackerRawData } from 'XrFrame/components/ARTracker';
    ...
    export { default as ShapeInteract, IShapeInteractData, ShapeInteractSchema } from 'XrFrame/components/physics/ShapeInteract';
...
declare module 'XrFrame/components/physics/SphereShape' {
    import Shape, { BasicShape, EShapeType, IShapeData, ShapeImpl, ShapeImplType } from "XrFrame/components/physics/Shape";
    import Vector3 from "XrFrame/math/vector3";
    import Element from "XrFrame/core/Element";
    import { IComponentSchema } from "XrFrame/core/Component";
    /**
...
declare module 'XrFrame/components/physics/MeshShape' {
    import Shape, { IShapeData, EShapeType, ShapeImplType, ShapeImpl, BasicShape } from "XrFrame/components/physics/Shape";
    import Element from "XrFrame/core/Element";
    import { IComponentSchema } from "XrFrame/core/Component";
    /**
        * @see {@link MeshShape}
...
declare module 'XrFrame/components/physics/Rigidbody' {
    ...
    export default class Rigidbody extends Component<IRigidbodyData> {
            ...
            /**
                ...
                */
            get rotationConstraints(): Array<boolean>;
            set rotationConstraints(v: Array<boolean>);
            /**
                * 限制物体的位移（X轴，Y轴，Z轴）。
                * @default [false, false, false]
                */
            get positionConstraints(): Array<boolean>;
            set positionConstraints(v: Array<boolean>);
            /**
...
declare module 'XrFrame/loader/GlTFLoader' {
    ...
    export default class GLTFLoader extends AssetLoader<GLTFModel, IGLTFLoaderOptions> {
            readonly schema: ILoaderOptionsSchema;
            load(param: IGLTFLoadData, callbacks: {
                    onLoading(progress: number): void;
            ...
            /**
                * @internal
                */
            static createGLTFModel(scene: Scene, buffer: ArrayBuffer, param: IGLTFLoadData, onLoading?: (progress: number) => void): Promise<GLTFModel>;
    }
    export {};
}
...
declare module 'XrFrame/loader/glTF/GLTFRootNode' {
    import GLTFAnimationsNode, { GLTFAnimationsLoaded, GLTFAnimationsNodeRaw } from "XrFrame/loader/glTF/animations/GLTFAnimationsNode";
    ...
    import GLTFMaterialsNode, { GLTFMaterialsLoaded, GLTFMaterialsNodeRaw } from "XrFrame/loader/glTF/materials/GLTFMaterialsNode";
    ...
    import GLTFSamplersNode, { GLTFSamplersLoaded, GLTFSamplersNodeRaw } from "XrFrame/loader/glTF/textures/GLTFSamplersNode";
    import GLTFTexturesNode, { GLTFTexturesLoaded, GLTFTexturesNodeRaw } from "XrFrame/loader/glTF/textures/GLTFTexturesNode";
    ...
    export default class GLTFRootNode extends GLTFBaseNode {
        ...
        nodesCollector: {
            [path: string]: Array<GLTFBaseNode>;
        };
        extensionProfiles: GLTFExtensionsProfiles;
        extensionGlobals: {
            [name: string]: object;
...
declare module 'XrFrame/physics/Collision' {
    ...
    import { Vector3_READONLY } from "XrFrame/math/vector3";
...
declare module 'XrFrame/kanata/lib/frontend' {
    ...
    export const decodeDraco: (buffer: ArrayBuffer | ArrayBufferView, decodeType: import('XrFrame/kanata/lib/backend').EDracoDecodeType) => import('XrFrame/kanata/lib/backend').DracoDecoded;
...
declare module 'XrFrame/components/physics/types' {
    export const allShapeNames: Array<string>;
    /**
        * 对刚体（在某个轴上的）位移和旋转的限制。
        *
        * @category Physics
...
declare module 'XrFrame/loader/glTF/buffers/GLTFBuffersNode' {
    ...
    export type GLTFBuffersLoaded = Array<GLTFBufferLoaded>;
...
declare module 'XrFrame/loader/glTF/GLTFBaseNode' {
    ...
    export abstract class GLTFBaseNode {
            ...
            protected validate(use: GLTFValidation<any>, pred?: boolean | string, ...args: Array<string>): this | {
                    and: typeof _empty;
            };
            /**
...
declare module 'XrFrame/loader/glTF/geometry/primitives/GLTFPrimitiveNode' {
    ...
    export type GLTFPrimitivePrerequisites = [materials: GLTFMaterialsLoaded, accessors: GLTFAccessorsLoaded, vbMap: Map<string, GLTF.VertexProperties>];
...
declare module 'XrFrame/kanata/lib/backend/native/worker' {
    import { IHandle, ETextureType, ETextureFormat, IRect, EMeshRenderType, INativeMap, ILongIntNativeMap, IGlyphInfo, IRenderEnv, EDracoDecodeType, DracoDecoded } from 'XrFrame/kanata/lib/backend/interface';
